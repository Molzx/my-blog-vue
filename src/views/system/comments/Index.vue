<template>
  <div class="content">
    <v-card flat class="card-1">
      ...
      <page-system-comment-display
        ref="list"
        class=" px-6 pt-4 pb-2"
      ></page-system-comment-display>

      <page-system-comment-detail ref="detail"></page-system-comment-detail>
      <page-system-comment-editer ref="edit"></page-system-comment-editer>
      <page-system-comment-addition ref="add"></page-system-comment-addition>
      <page-system-comment-delete ref="delete"></page-system-comment-delete>
    </v-card>
  </div>
</template>
