<template>
  <div class="content">
    <v-card flat class="card-1">
      ...
      <page-system-announcement-display
        ref="list"
        class=" px-6 pt-4 pb-2"
      ></page-system-announcement-display>

      <page-system-announcement-detail
        ref="detail"
      ></page-system-announcement-detail>
      <page-system-announcement-editer
        ref="edit"
      ></page-system-announcement-editer>
      <page-system-announcement-addition
        ref="add"
      ></page-system-announcement-addition>
      <page-system-announcement-delete
        ref="delete"
      ></page-system-announcement-delete>
    </v-card>
  </div>
...
export default {
  ...
  methods: {
    ...
    //===获取需要的数据方法===
    getUseAnnouncementId() {
      return this.getUseRecordId
    },
    setUseAnnouncementId(id) {
