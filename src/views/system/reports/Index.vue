<template>
  <div class="content">
    <v-card flat class="card-1">
      ...
      <page-system-report-display
        ref="list"
        class=" px-6 pt-4 pb-2"
      ></page-system-report-display>

      <page-system-report-detail ref="detail"></page-system-report-detail>
      <page-system-report-editer ref="edit"></page-system-report-editer>
      <page-system-report-addition ref="add"></page-system-report-addition>
      <page-system-report-delete ref="delete"></page-system-report-delete>
    </v-card>
  </div>
</template>
