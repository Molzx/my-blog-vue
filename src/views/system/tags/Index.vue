<template>
  <div class="content">
    <v-card flat class="card-1">
      ...
      <page-system-tag-display
        ref="list"
        class=" px-6 pt-4 pb-2"
      ></page-system-tag-display>

      <page-system-tag-detail ref="detail"></page-system-tag-detail>
      <page-system-tag-editer ref="edit"></page-system-tag-editer>
      <page-system-tag-addition ref="add"></page-system-tag-addition>
      <page-system-tag-delete ref="delete"></page-system-tag-delete>
    </v-card>
  </div>
</template>
