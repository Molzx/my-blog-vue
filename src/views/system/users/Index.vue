  ...
  <div class="content">
    <v-card flat class="card-1">
      ...
      <v-window class="card__window" v-model="currentPage" reverse>
        ...
        >
          <page-system-user-display ref="page0"></page-system-user-display>
        </v-window-item>
        ...
        <v-window-item
          ...
          transition="scale-transition"
        >
          <page-system-user-detail ref="page1"></page-system-user-detail>
        </v-window-item>
        ...
        <v-window-item
          ...
          transition="scale-transition"
        >
          <page-system-user-editer ref="page2"></page-system-user-editer>
        </v-window-item>
        <v-window-item
          :value="3"
          reverse-transition="slide-y-transition"
          transition="scale-transition"
        >
          <page-system-user-addition ref="page3"></page-system-user-addition>
        </v-window-item>
      </v-window>
      <page-system-user-delete ref="delete"></page-system-user-delete>
    </v-card>
  </div>
</template>
