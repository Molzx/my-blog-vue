<template>
  <div class="content">
    <v-card flat class="card-1">
      ...
      <page-system-category-display
        ref="list"
        class=" px-6 pt-4 pb-2"
      ></page-system-category-display>

      <page-system-category-detail ref="detail"></page-system-category-detail>
      <page-system-category-editer ref="edit"></page-system-category-editer>
      <page-system-category-addition ref="add"></page-system-category-addition>
      <page-system-category-delete ref="delete"></page-system-category-delete>
    </v-card>
  </div>
</template>
