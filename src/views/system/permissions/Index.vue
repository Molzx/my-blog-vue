  ...
  <div class="content">
    <v-card flat class="card-1">
      ...
      <v-window class="card__window" v-model="currentPage" reverse>
        ...
        >
          <page-system-permission-display
            ref="page0"
          ></page-system-permission-display>
        </v-window-item>
        ...
        <v-window-item
          ...
          transition="scale-transition"
        >
          <page-system-permission-addition
            ref="page3"
          ></page-system-permission-addition>
        </v-window-item>
      </v-window>
      <page-system-permission-delete
        ref="delete"
      ></page-system-permission-delete>
    </v-card>
  </div>
